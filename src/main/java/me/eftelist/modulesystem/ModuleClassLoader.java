...
public class ModuleClassLoader extends URLClassLoader {
    ...
    ModuleClassLoader(ModuleLoader loader, ClassLoader parent, ModuleDescriptionFile description, File file) throws MalformedURLException, MalformedURLException {
        ...
        try {
            ...
            Core.getInstance().getLogger().severe("Cannot find main class `" + description.getMain() + "`");
            return;
        }
        ...
        if (IModule.class.isAssignableFrom(mainClass)) {
            ...
            Core.getInstance().getLogger().severe("Declared main class `" + description.getMain() + "` does not implement from class IModule");
        }
    }
